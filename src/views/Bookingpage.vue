    ...
    <div id="bookingpage" class="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen">
        ...
        <div class="xl:flex-1 xl:flex xl:overflow-y-hidden">
          ...
          <main class="py-6 xl:flex-1 xl:overflow-x-hidden">
              ...
              <div class="mt-6 sm:overflow-x-auto scrollbar scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-100 scrollbar-thumb-rounded-md scrollbar-track-rounded-full hover:scrollbar-thumb-gray-600 sm:overflow-y-hidden">
