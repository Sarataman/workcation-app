<template>
  <div id="app" class="antialiased bg-gray-100">
        ...
        <div class="xl:max-w-6xl lg:mx-auto">
          <div class="lg:w-7/12 lg:pl-12 lg:pr-8">
              ...
              <div class="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
                  <img class="h-56 w-full object-cover object-center sm:h-56 rounded-lg shadow-xl lg:inset-0 lg:h-full lg:object-left lg:shadow-none lg:rounded-none" src="/beach-work.png" alt="man working on beach">
                  <svg class="hidden lg:block lg:absolute lg:inset-y-0 lg:left-0 lg:w-16 lg:h-full" viewBox="0 0 100 100" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="mt-6">
                  <router-link to="/bookingpage">
                    <a href="#" class="px-5 py-3 inline-block bg-indigo-500 hover:bg-indigo-400 rounded-lg text-white font-semibold tracking-wide uppercase shadow-lg"> Book your escape</a>
                  </router-link>
              </div>
          </div>
          </div>
