<template>
  <section class="bg-gray-800 xl:w-72">
    ...
    <form :class="{ 'hidden': !isOpen, 'block': isOpen }" class="xl:block xl:h-full xl:flex xl:flex-col xl:justify-between">
      <div class="lg:flex xl:block xl:overflow-y-auto scrollbar scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-100 scrollbar-thumb-rounded-md scrollbar-track-rounded-full hover:scrollbar-thumb-gray-600">
        <div class="px-4 py-4 border border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
        ...
        <div class="px-4 py-4 border border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
